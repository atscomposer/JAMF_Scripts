...
lookupAccount="svc_sccm_join_domain"
...
if [[ $? -ne 0 ]]; then
  die "It doesn't look like this Mac is communicating with AD correctly. Ensure you are on iRobot Secure or are connected to the office LAN. Exiting the script."
fi
